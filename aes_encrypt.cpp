// aes_encrypt.cpp - Chương trình mã hóa AES
#include "aes.h"
...
int main(int argc, char* argv[]) {
    try {
        ...
        // Mã hóa dữ liệu
        std::string ciphertext = AES::encrypt(plaintext, key, aesType);
        
        // Ghi kết quả vào file
        FileUtils::writeOutput(outputFile, ciphertext);
        
        std::cout << "Mã hóa AES thành công. Kết quả được lưu vào: " << outputFile << std::endl;
        return 0;
    }
